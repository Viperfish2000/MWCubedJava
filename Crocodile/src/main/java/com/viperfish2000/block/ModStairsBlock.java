package com.viperfish2000.block;
...
public class ModStairsBlock extends Block implements IWaterLoggable {
   ...
   protected static final VoxelShape AABB_SLAB_TOP = TOP_SHAPE;
   protected static final VoxelShape AABB_SLAB_BOTTOM = BOTTOM_SHAPE;
   ...
   @Deprecated
public ModStairsBlock(BlockState state, Block.Properties properties) {
      super(properties);
   ...
   public ModStairsBlock(java.util.function.Supplier<BlockState> state, Block.Properties properties) {
      super(properties);
      this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(HALF, Half.BOTTOM).with(SHAPE, StairsShape.STRAIGHT).with(WATERLOGGED, Boolean.valueOf(false)));
   ...
   public static boolean isBlockStairs(BlockState state) {
      return state.getBlock() instanceof ModStairsBlock;
   }
