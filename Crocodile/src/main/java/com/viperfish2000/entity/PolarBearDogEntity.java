...
public class PolarBearDogEntity extends TameableHorse {
   private static final DataParameter<Boolean> BEGGING = EntityDataManager.createKey(PolarBearDogEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.createKey(PolarBearDogEntity.class, DataSerializers.VARINT);
   ...
   public PolarBearDogEntity(EntityType<? extends PolarBearDogEntity> type, World worldIn) {
      super(type, worldIn);
      this.setTamed(false);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new PolarBearDogEntity.AvoidEntityGoal(this, LlamaEntity.class, 24.0F, 1.5D, 1.5D));
   ...
   public boolean canMateWith(AnimalEntity otherAnimal) {
      if (otherAnimal == this) {
         ...
         return false;
      } else if (!(otherAnimal instanceof PolarBearDogEntity)) {
         return false;
      } else {
         PolarBearDogEntity wolfentity = (PolarBearDogEntity)otherAnimal;
   ...
   public boolean shouldAttackEntity(LivingEntity target, LivingEntity owner) {
      if (!(target instanceof CreeperEntity) && !(target instanceof GhastEntity)) {
         if (target instanceof PolarBearDogEntity) {
            PolarBearDogEntity wolfentity = (PolarBearDogEntity)target;
   ...
   class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
      private final PolarBearDogEntity wolf;

      public AvoidEntityGoal(PolarBearDogEntity wolfIn, Class<T> entityClassToAvoidIn, float avoidDistanceIn, double farSpeedIn, double nearSpeedIn) {
      ...
      private boolean avoidLlama(LlamaEntity llamaIn) {
         return llamaIn.getStrength() >= PolarBearDogEntity.this.rand.nextInt(5);
      }
      ...
      public void startExecuting() {
         PolarBearDogEntity.this.setAttackTarget((LivingEntity)null);
