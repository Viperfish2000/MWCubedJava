...
public class FollowOwnerGoalMod extends Goal {
   private final BearDogEntity tameable;
   ...
   public FollowOwnerGoalMod(BearDogEntity p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {
