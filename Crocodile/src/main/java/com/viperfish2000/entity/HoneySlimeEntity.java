...
public class HoneySlimeEntity extends MobEntity implements IMob {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new HoneySlimeEntity.AttackGoal(this));
   ...
   public void tick() {
      ...
      if (this.isAlive()) {
      if(this.getHealth() == 0 || this.getHealth() <1 )
      {
    	  this.explode();
      }
      }
   ...
   public void remove(boolean keepData) {
      ...
      if (!this.world.isRemote && i > 1 && this.getHealth() <= 0.0F && !this.removed) {
         ...
         for(int k = 0; k < j; ++k) {
            ...
            HoneySlimeEntity.setLocationAndAngles(this.getPosX() + (double)f, this.getPosY() + 0.5D, this.getPosZ() + (double)f1, this.rand.nextFloat() * 360.0F, 0.0F);
   ...
   protected void dealDamage(LivingEntity entityIn) {
      if (this.isAlive()) {
         ...
         if (entityIn instanceof LivingEntity) {
	            ...
	            if (a > 0) {
	               ((LivingEntity)entityIn).addPotionEffect(new EffectInstance(Effects.POISON, a * 10, 1));
	               ((LivingEntity)entityIn).addPotionEffect(new EffectInstance(Effects.NAUSEA, a * 10 + 20, 0));
	            }
	         }
      }
   ...
   public boolean attackEntityAsMob(Entity entityIn) {
	      if (super.attackEntityAsMob(entityIn)) {
	         if (entityIn instanceof LivingEntity) {
	            ...
	            if (i > 0) {
	            	 ((LivingEntity)entityIn).addPotionEffect(new EffectInstance(Effects.POISON, i * 10, 1));
		               ((LivingEntity)entityIn).addPotionEffect(new EffectInstance(Effects.NAUSEA, i * 10 + 20, 1));
	            }
	         }
