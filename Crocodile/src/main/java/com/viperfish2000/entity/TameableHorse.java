...
public abstract class TameableHorse extends TameableEntity implements IInventoryChangedListener, IJumpingMount {
   private static final Predicate<LivingEntity> IS_HORSE_BREEDING = (p_213617_0_) -> {
      return p_213617_0_ instanceof TameableHorse && ((TameableHorse)p_213617_0_).isBreeding();
   };
   ...
   private static final DataParameter<Byte> STATUS = EntityDataManager.createKey(TameableHorse.class, DataSerializers.BYTE);
   private static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(TameableHorse.class, DataSerializers.OPTIONAL_UNIQUE_ID);
   ...
   protected TameableHorse(EntityType<? extends TameableHorse> type, World worldIn) {
      super(type, worldIn);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new BreedGoal(this, 1.0D, TameableHorse.class));
   ...
   public void openHorseInventory(TameableHorse horse, IInventory inventoryIn) {
   }
   ...
   protected void followMother() {
      if (this.isBreeding() && this.isChild() && !this.isEatingHaystack()) {
         LivingEntity livingentity = this.world.getClosestEntityWithinAABB(TameableHorse.class, MOMMY_TARGETING, this, this.getPosX(), this.getPosY(), this.getPosZ(), this.getBoundingBox().grow(16.0D));
   ...
   protected void setOffspringAttributes(AgeableEntity p_190681_1_, TameableHorse p_190681_2_) {
