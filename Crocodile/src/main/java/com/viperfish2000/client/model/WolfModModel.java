...
@OnlyIn(Dist.CLIENT)
public class WolfModModel<T extends WolfEntity> extends TintedAgeableModel<T> {
	...
	public WolfModModel() {
		...
		group.setRotationPoint(1.0F, 10.5F, 7.0F);
		head.addChild(group);
		group.setTextureOffset(40, 24).addBox(-3.5F, -14.5F, -9.5F, 7.0F, 3.0F, 5.0F, 0.0F, false);

		bone = new ModelRenderer(this);
		bone.setRotationPoint(-1.0F, -16.0F, -7.0F);
		group.addChild(bone);
		bone.setTextureOffset(54, 0).addBox(0.3787F, -3.0F, 0.0F, 5.0F, 5.0F, 0.0F, 0.0F, false);
	}
