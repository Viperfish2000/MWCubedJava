...
import com.viperfish2000.entity.ModBoatEntity;
...
@OnlyIn(Dist.CLIENT)
public class BoatModel extends SegmentedModel<ModBoatEntity> {
   ...
   public BoatModel() {
	   ModelRenderer[] amodelrenderer = new ModelRenderer[]{(new ModelRenderer(this, 0, 0)).setTextureSize(128, 64), (new ModelRenderer(this, 0, 19)).setTextureSize(128, 64), (new ModelRenderer(this, 0, 27)).setTextureSize(128, 64), (new ModelRenderer(this, 0, 35)).setTextureSize(128, 64), (new ModelRenderer(this, 0, 43)).setTextureSize(128, 64),  (new ModelRenderer(this, 0, 19)).setTextureSize(64, 64), (new ModelRenderer(this, 0, 0)).setTextureSize(64, 64), (new ModelRenderer(this, 0, 0)).setTextureSize(64, 64)};
	     int i = 32;
      int j = 6;
      int k = 20;
      int l = 4;
     ...
     // amodelrenderer[5] = new ModelRenderer(64, 64, 0, 19);
      amodelrenderer[5].addBox(1.0F, 0.0F, 1.0F, 14.0F, 10.0F, 14.0F, 0.0F);
      //amodelrenderer[6] = new ModelRenderer(64, 64, 0, 0);
      amodelrenderer[6].addBox(1.0F, 0.0F, 0.0F, 14.0F, 5.0F, 14.0F, 0.0F);
      amodelrenderer[6].rotationPointY = 9.0F;
      amodelrenderer[6].rotationPointZ = 1.0F;
      //amodelrenderer[7] = new ModelRenderer(64, 64, 0, 0);
      amodelrenderer[7].addBox(7.0F, -1.0F, 15.0F, 2.0F, 4.0F, 1.0F, 0.0F);
      amodelrenderer[7].rotationPointY = 8.0F;
    ...
    */
   public void setRotationAngles(ModBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(ModBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
