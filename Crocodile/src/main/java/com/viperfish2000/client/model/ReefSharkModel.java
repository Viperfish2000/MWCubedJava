 ...
 */
public class ReefSharkModel<T extends ReefSharkEntity> extends SegmentedModel<T> {
	...
	public ReefSharkModel() {
		textureWidth = 64;
		textureHeight = 64;

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, 29.0F, 0.0F);
		body.setTextureOffset(0, 0).addBox(-4.0F, -12.0F, -6.0F, 7.0F, 7.0F, 12.0F, 0.0F, false);
		...
		topjaw.setRotationPoint(0.1736F, -2.5F, 0.4848F);
		head.addChild(topjaw);
		topjaw.setTextureOffset(0, 0).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		topjaw.setTextureOffset(21, 21).addBox(-3.5F, -0.5F, -9.2412F, 6.0F, 2.0F, 9.0F, 0.0F, false);

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(0.0F, 6.0353F, -3.1363F);
		topjaw.addChild(bone4);
		setRotationAngle(bone4, -0.2618F, 0.0F, 0.0F);
		bone4.setTextureOffset(0, 19).addBox(-3.75F, -4.7853F, -6.788F, 6.0F, 2.0F, 9.0F, 0.0F, false);

		jaw = new ModelRenderer(this);
		jaw.setRotationPoint(-0.5F, 1.75F, -1.0F);
		head.addChild(jaw);
		setRotationAngle(jaw, -0.1745F, 0.0F, 0.0F);
		jaw.setTextureOffset(0, 30).addBox(-2.5F, 0.0F, -5.0F, 5.0F, 1.0F, 6.0F, 0.0F, false);

		tail = new ModelRenderer(this);
		tail.setRotationPoint(0.0F, -8.0F, 5.0F);
		body.addChild(tail);
		tail.setTextureOffset(26, 0).addBox(-3.0F, -3.25F, 1.0F, 5.0F, 4.0F, 8.0F, 0.0F, false);

		bone6 = new ModelRenderer(this);
		bone6.setRotationPoint(-0.5F, -1.5F, 6.0F);
		tail.addChild(bone6);
		setRotationAngle(bone6, -0.6109F, 0.0F, 0.0F);
		bone6.setTextureOffset(39, 13).addBox(-0.5F, -3.3604F, -0.7713F, 1.0F, 4.0F, 3.0F, 0.0F, false);

		tail2 = new ModelRenderer(this);
		tail2.setRotationPoint(0.0F, -1.0F, 8.0F);
		tail.addChild(tail2);
		tail2.setTextureOffset(24, 32).addBox(-2.0F, -1.5F, 1.0F, 3.0F, 2.0F, 3.0F, 0.0F, false);

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(0.0F, -13.0F, -17.0F);
		...
		bone.setTextureOffset(14, 32).addBox(-1.1434F, 2.3111F, 23.6205F, 1.0F, 2.0F, 8.0F, 0.0F, false);

		antfin = new ModelRenderer(this);
		antfin.setRotationPoint(0.0F, 7.25F, -11.75F);
		...
		antfin2.setTextureOffset(40, 32).addBox(0.5F, -13.7523F, 6.6904F, 1.0F, 2.0F, 4.0F, 0.0F, true);

		antfin3 = new ModelRenderer(this);
		antfin3.setRotationPoint(-1.5F, 6.75F, -5.75F);
		tail.addChild(antfin3);
		setRotationAngle(antfin3, -0.4363F, 0.0F, 0.0F);
		antfin3.setTextureOffset(40, 38).addBox(0.5F, -12.846F, 7.1131F, 1.0F, 2.0F, 4.0F, 0.0F, false);

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(-4.0F, -8.0F, -3.0F);
		body.addChild(bone3);
		setRotationAngle(bone3, -0.8727F, 0.0F, 0.8727F);
		bone3.setTextureOffset(0, 37).addBox(-0.234F, 0.4132F, 0.4924F, 1.0F, 3.0F, 6.0F, 0.0F, false);

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(3.0F, -8.0F, -3.0F);
		body.addChild(bone5);
		setRotationAngle(bone5, -0.8727F, 0.0F, -0.8727F);
		bone5.setTextureOffset(0, 37).addBox(-0.766F, 0.4132F, 0.4924F, 1.0F, 3.0F, 6.0F, 0.0F, true);
		...
		fintail.setTextureOffset(38, 12).addBox(-1.0F, -17.0F, 0.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
	}
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		if (entityIn instanceof ReefSharkEntity) {
			ReefSharkEntity ReefSharkEntity = (ReefSharkEntity) entityIn;
